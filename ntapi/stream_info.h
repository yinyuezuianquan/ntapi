...
struct NtInfoSDRAMInfo_s {
  ...
  enum NtSdramSize_e size;              //!< The SDRAM size
};
...
struct NtInfoTimeSync_v4_s {
  ...
  enum NtTimeSyncConnectorSetting_e timeSyncConnectorExt1; //!< Timesync connector Ext1 setting
  enum NtTimeSyncConnectorSetting_e timeSyncConnectorInt1; //!< Timesync connector Int1 setting
  enum NtTimeSyncConnectorSetting_e timeSyncConnectorInt2; //!< Timesync connector Int2 setting
...
struct NtInfoCmdPortPathDelay_s {
  uint8_t portNo;       //!< Virtual port number on which to query path delay
