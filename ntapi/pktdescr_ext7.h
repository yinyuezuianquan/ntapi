...
#define _NT_NET_GET_PKT_DEDUPLICATION_CRC_EXT7(_hNetBuf_)      (_NT_NET_ASSERT(~0))
...
#define NT_NET_GET_PKT_DEDUPLICATION_CRC(_hNetBuf_)      _NT_NET_GET_PKT_DEDUPLICATION_CRC_EXT7(_hNetBuf_)
