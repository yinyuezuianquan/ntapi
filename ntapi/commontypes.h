...
enum NtAdapterType_e {
  ...
  NT_ADAPTER_TYPE_NT200A01_2X100 = NT_ADAPTER_TYPE_NT200A01, //!< NT200A01 2 x 100GB network adapter
  NT_ADAPTER_TYPE_NT40A01_4X1,   //!< NT40A01_4X1 network adapter with IEEE1588
  NT_ADAPTER_TYPE_NT200A01_2X40, //!< NT200A01 2 x 40GB network adapter
  //
