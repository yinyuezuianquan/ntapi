...
} NtDyn1Descr_t; // descrFormat = 1, descrLength = 18
...
/** @def NT_NET_DESCR_PTR_DYN1
 *  @brief Get a pointer to the packet descriptor
 *  @param[in] "_hNetBuf_" Packet container reference
 *  @return Returns a pointer of type NtDyn1Descr_t*
 *  @hideinitializer
 */
#define NT_NET_DESCR_PTR_DYN1(_hNetBuf_)                ((_NT_NET_GET_PKT_DESCR_PTR_DYN1(_hNetBuf_)->descrFormat==1 ? \
